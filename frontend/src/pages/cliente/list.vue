                ...
                <div class="container-fluid">
                    <div class="grid justify-content-between align-items-center">
                        ...
                        <div  class="col-12 md:col-3 " >
                            <router-link :to="`/cliente/add`">
                                <Button :label="$t('addNewCliente')" icon="pi pi-plus" type="button" class="p-button bg-primary "  />
                            </router-link>
                        </div>
                    ...
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag && !isSubPage">
                                <Breadcrumb :home="{icon: 'pi pi-home', to: '/cliente'}" :model="pageBreadCrumb" />
                            </template>
...
<script setup>
	...
	function getActionMenuModel(data){
		...
		{
			label: () => $t('view'),
			to: `/cliente/view/${data.id}`,
			icon: "pi pi-eye"
		},
		{
			label: () => $t('edit'),
			to: `/cliente/edit/${data.id}`,
			icon: "pi pi-pencil"
		},
		{
			label: () => $t('delete'),
