                    ...
                    <div class="grid justify-content-between align-items-center">
                        ...
                        <div  class="col-12 md:col-3 " >
                            <router-link :to="`/blog/add`">
                                <Button :label="$t('addNewBlog')" icon="pi pi-plus" type="button" class="p-button bg-primary "  />
                            </router-link>
                        </div>
                    ...
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag && !isSubPage">
                                <Breadcrumb :home="{icon: 'pi pi-home', to: '/blog'}" :model="pageBreadCrumb" />
                            </template>
                            ...
                            <div class="page-records"  >
                                <DataTable :lazy="true"   :loading="loading"    v-model:selection="selectedItems"
                                    ...
                                    <Column selectionMode="multiple" headerStyle="width: 2rem" />
                                        <Column  field="articulo" :header="$t('articulo')" >
                                            <template #body="{data}">
                                                {{ data.articulo }}
                                            </template>
                                        </Column>
                                        <Column  field="destacado" :header="$t('destacado')" >
                                            <template #body="{data}">
                                                {{ data.destacado }}
                                            </template>
                                        </Column>
